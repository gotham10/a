...
function Finity.new(title, size, extra, callback)
    ...
    content.Position = UDim2.new(0, 151, 0, 36)
    content.Size = UDim2.new(1, -151, 1, -36)
    content.BackgroundTransparency = 1

    TweenService:Create(main, TweenInfo.new(0.8, Enum.EasingStyle.Quint), {Position = UDim2.new(0.5, -size.X.Offset/2, 0.5, -size.Y.Offset/2), BackgroundTransparency = 0}):Play()
    ...
    function UI:Category(name)
        ...
        leftSide.Position = UDim2.new(0, 6, 0, 15)
        ...
        selInd.Size = UDim2.new(0, 2, 0, 12)
        selInd.Position = UDim2.new(0, 0, 0.5, -6)
        selInd.BackgroundColor3 = Color3.fromRGB(150, 100, 255)
        selInd.BorderSizePixel = 0
        selInd.Transparency = 1
        Instance.new("UICorner", selInd)

        btn.MouseButton1Click:Connect(function()
            for _, v in pairs(content:GetChildren()) do v.Visible = false end
            for _, b in pairs(sidebar:GetChildren()) do 
                if b:IsA("TextButton") then 
                    TweenService:Create(b, TweenInfo.new(0.3), {TextColor3 = Color3.fromRGB(140, 140, 140), BackgroundTransparency = 1}):Play()
                    TweenService:Create(b:FindFirstChild("Frame"), TweenInfo.new(0.3), {Transparency = 1}):Play()
                end 
            end
            catFrame.Visible = true
            TweenService:Create(btn, TweenInfo.new(0.3), {TextColor3 = Color3.fromRGB(150, 100, 255), BackgroundTransparency = 0.94}):Play()
            TweenService:Create(selInd, TweenInfo.new(0.3), {Transparency = 0}):Play()
            
            for _, sect in pairs(catFrame:GetDescendants()) do
                if sect:IsA("Frame") and sect.Name == "SectorFrame" then
                    sect.Position = sect.Position + UDim2.new(0, 0, 0, 20)
                    sect.BackgroundTransparency = 1
                    TweenService:Create(sect, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Position = sect.Position - UDim2.new(0, 0, 0, 20), BackgroundTransparency = 0}):Play()
                end
            end
        end)
        ...
        function cat:Sector(secName)
            ...
            Instance.new("UIPadding", secFrame).PaddingBottom = UDim.new(0, 8)
            ...
            function sector:Cheat(type, label, callback, options)
                ...
                elseif type == "Button" then
                    ...
                    b.MouseEnter:Connect(function() TweenService:Create(b, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(38, 38, 38)}):Play() end)
                ...
                elseif type == "Checkbox" then
                    ...
                    back.BackgroundColor3 = val and Color3.fromRGB(150, 100, 255) or Color3.fromRGB(40, 40, 40)
                    ...
                    function cheat:toggleState(s)
                        ...
                        TweenService:Create(back, TweenInfo.new(0.25), {BackgroundColor3 = val and Color3.fromRGB(150, 100, 255) or Color3.fromRGB(40, 40, 40)}):Play()
